...
class CreateMessage2 extends StatefulWidget {
  @override
  CreateMessage2State createState() => CreateMessage2State();
}

class CreateMessage2State extends State<CreateMessage2> {
    ...
    return new InkWell(
      ...
      onTap: () async {
        ...
        if (type == FileType.video) {
          selectedFile = (await FilePicker.platform.pickFiles()) as File;
